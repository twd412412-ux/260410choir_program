...
function seating() {
  ...
  const c = vm.createContext({
    ...
    seatingRows: [{ label: '0단', seats: [{ name: 'before' }] }], seatingOrchestraRows: [], seatingMicSlots: [], seatingSpecialSlots: {}, seatingCenterOffset: 0, seatingOrchestraCenterOffset: 0,
    seatingProgramLink: null, seatingMicVisible: true,
    ...
    seatingAbsentPlacementWarning: () => '', confirm: () => true,
    normalizeSeatingProgramLink: value => value, seatingFolderName: value => value || '', seatingInputValue: () => '',
